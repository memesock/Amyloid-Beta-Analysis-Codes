...
# MORE INFORMATION ABOUT THERMOSTATS AND BAROSTATS IN THE MDP FOLDER FOR DIFFERENT STAGES OF RUN

THIS NEXT SECTION IS THE MOST IMPORTANT IN DECIDING THE FORCE FIELD (MARTINI3, SCALED MARTINI3, MARTINI3-IDP
#######################################################################
##############################################################
######################################################
...
martinize2 -f dimer.pdb -o topol.top -x protein_cg.pdb -ff martini3IDP -cys auto -idr-tune -id-regions 1:42
...
# ONE MUST HAVE A MDP FOLDER AND martini_v3 FOLDER READY TOO (CHECK AGAIN THE FOLDER NAME AGAIN, martini_v300 and martini_v3.0.0 are supposed to be samr). I HAVE INCLUDED THE DEFUALT LAMBDA OF 1 FOR PROTEIN-WATER SCALING IN martini_v3.0.0/martini_v3.0.0.itp, ONE CAN CHANGE IT USING THE LAMBDA DIRECTORY PYTHON FILE.
